...
import firis.yuzukitools.plugin.client.jei.recipe.JEIRecipeInstantHouseEnchantmentWrapper;
...
public class JEIYuzukiToolsPlugin implements IModPlugin {
	...
	public void register(@Nonnull IModRegistry registry) {
		...
		//インスタントハウスのカスタムレシピ登録
		registry.handleRecipes(RecipeInstantHouse.class, 
				JEIRecipeInstantHouseEnchantmentWrapper::new,
				VanillaRecipeCategoryUid.CRAFTING);
